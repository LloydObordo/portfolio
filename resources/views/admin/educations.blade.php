    ...
    <div class="col-md-12">
      <div class="card card-primary card-outline mb-4">
        <div class="card-header">
          <h3 class="card-title mb-0"><i class="fas fa-user-graduate mr-2"></i>Education Records</h3>
        ...
        <div class="card-body">
          <table id="educationTable" class="table table-sm table-hover text-center">
            <thead>
                <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="addItemModalLabel">Add Education</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="addItemForm" method="POST" action="{{ route('educations.store') }}" enctype="multipart/form-data" novalidate>
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="institution" name="institution" value="{{ old('institution') }}" placeholder="--Institution Name--">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4" id="degree" name="degree">
                                    <option value="" selected disabled>--Select--</option>
                                    @foreach($educations as $education)
                                        <option value="{{ $education['id'] }}">{{ $education['description'] }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">Please provide the degree earned.</div>
                            </div>
                            <div class="form-group">
                                <label for="field_of_study">Field of Study<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="field_of_study" name="field_of_study" value="{{ old('field_of_study') }}" placeholder="--Field of Study--">
                                <div class="invalid-feedback">Please provide the field of study.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                            ...
                            <div class="form-group">
                                <label for="is_current">Current Education? <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="1" class="form-control" id="order" name="order" value="{{ old('order') }}" placeholder="--Order of education in the list--">
...
<div class="modal fade" id="edit_item_modal" tabindex="-1" role="dialog" aria-labelledby="editItemModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="editItemModalLabel">Edit Education</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="editItemForm" method="POST" action="{{ route('educations.update') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="institution">Institution <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="itemInstitution_edit" name="institution" placeholder="--Institution Name--">
                                <div class="invalid-feedback">Please provide the institution name.</div>
                            </div>
                            <div class="form-group">
                                <label for="degree">Degree <span class="text-danger">*</span></label>
                                <select class="form-control select2bs4" id="itemDegree_edit" name="degree">
                                    <option value="" selected disabled>--Select--</option>
                                    @foreach($educations as $education)
                                        <option value="{{ $education['id'] }}">{{ $education['description'] }}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                <label for="field_of_study">Field of Study<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="itemFieldOfStudy_edit" name="field_of_study" placeholder="--Field of Study--">
                                <div class="invalid-feedback">Please provide the field of study.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="order">Display Order <span class="text-danger">*</span></label>
                                <input type="number" min="1" class="form-control" id="itemOrder_edit" name="order" placeholder="--Order of education in the list--">
                                <div class="invalid-feedback">Please provide a valid order number.</div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="delete_item_modal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="deleteUserForm" method="POST" action="{{ route('educations.delete') }}">
                @csrf
...
<div class="modal fade" id="restore_item_modal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="restoreUserForm" method="POST" action="{{ route('educations.restore') }}">
                @csrf
...
<script>
    ...
    $(document).ready(function() {
       var table = $('#educationTable').DataTable({
            ...
            ajax: {
                url: "{{ route('educations.show.data') }}",
                type: "POST",
                headers: {
                ...
                data: function (d) {
                    d._token = "{{ csrf_token() }}";
                    d.institutionFilter = $('#institutionFilter').val();
                    d.degreeFilter = $('#degreeFilter').val();
                    d.fieldFilter = $('#fieldFilter').val();
        ...
        $('#institutionFilter, #degreeFilter, #fieldFilter, #startDateFilter, #endDateFilter, #isCurrentFilter, #orderFilter').on('change keyup', function() {
            table.ajax.reload();
        });
        ...
        $('#resetFilters').click(function () {
            ...
            const currentFilters = {
                institution: $('#institutionFilter').val(),
                degree: $('#degreeFilter').val(),
            ...
            const needsReset = currentFilters.institution !== 'all' ||
                currentFilters.degree !== 'all' ||
            ...
            if (needsReset) {
                // Clear input fields
                $('#institutionFilter').val('all');
                $('#degreeFilter').val('all');
                $('#fieldFilter').val('all');
                $('#startDateFilter').val('');
                $('#endDateFilter').val('');
...
<script>
    ...
    $('#edit_item_modal').on('show.bs.modal', function(event) {
        ...
        $('#itemInstitution_edit').val(item.institution);
        $('#itemDegree_edit').val(item.degree).trigger('change');
        $('#itemFieldOfStudy_edit').val(item.field_of_study);
