...
class Google2FAController extends Controller
{
    ...
    public function register()
    {
        ...
        if (!session()->has('qr_code')) {
            ...
            $qrCode = new QrCode(
                data: 'otpauth://totp/Portfolio:' . $user->email . '?secret=' . $secret . '&issuer=Portfolio',
        ...
        return view('auth.google2fa.register', compact('imageUrl', 'secret'));
    }
    ...
    {
        return view('auth.google2fa.verify');
    }
